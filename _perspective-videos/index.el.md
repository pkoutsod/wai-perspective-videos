...
title: "Βίντεο Προοπτικών Προσβασιμότητας Παγκόσμιου Ιστού: Εξερευνήστε τον Αντίκτυπο και τα Οφέλη για Όλους"
title_html: "Βίντεο Προοπτικών Προσβασιμότητας Παγκόσμιου Ιστού:<br>Εξερευνήστε τον Αντίκτυπο και τα Οφέλη για Όλους"
nav_title: "Επισκόπηση Βίντεο Προοπτικών"
...
- name: "Panos Koutsodimitropoulos"   # Replace Jan Doe with translator name
# - name: "Jan Doe"   # Replace Jan Doe with name, or delete this line if not multiple translators
# contributors:
# - name: "Jan Doe"   # Replace Jan Doe with contributor name, or delete this line if none
# - name: "Jan Doe"   # Replace Jan Doe with name, or delete this line if not multiple contributors

permalink: /perspective-videos/el # Add the language shortcode to the end, with no slash at the end. For example /path/to/file/fr
...
description: Σύντομα βίντεο που δείχνουν πώς η Προσβασιμότητα στον Παγκόσμιο Ιστό είναι απαραίτητη για τα άτομα με αναπηρία και χρήσιμη για όλους σε διάφορες καταστάσεις
